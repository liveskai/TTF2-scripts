global function ClTitanStryder_Init

void function ClTitanStryder_Init( asset titan_model )
{
	...
	ModelFX_BeginData( "titanDoomed", titan_model, "all", false )
		...
		//fire fx
		ModelFX_AddTagHealthFX( 1.0, "exp_L_shoulder", $"P_xo_damage_fire_2_alt", false )
		ModelFX_AddTagHealthFX( 1.0, "exp_L_elbow", $"P_xo_damage_fire_2_alt", false )
		...
		ModelFX_AddTagHealthFX( 1.0, "exp_L_thigh", $"P_xo_damage_fire_2", false )
		ModelFX_AddTagHealthFX( 1.0, "exp_L_knee", $"P_xo_damage_fire_2", false )
		ModelFX_AddTagHealthFX( 1.0, "exp_R_thigh", $"P_xo_damage_fire_1", false )
